                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    for($i = 0 ; $i < $nRows; $i++){
                                        ?>
                                        <tr>
                                            <td><?php echo $obj[$i]["schedule_type_id"];?></td>
                                            <td><?php echo $obj[$i]["type_name"];?></td>
                                            <td><button class="btn btn-primary"data-toggle="modal" data-target="#editModal<?php echo $obj[$i]["schedule_type_id"];?>"><i class="glyphicon glyphicon-search"></i>Edit</button></td>
                                            <td><button class="btn btn-danger" data-toggle="modal" data-target="#delModal<?php echo $obj[$i]["schedule_type_id"];?>"><i class="glyphicon glyphicon-remove"></i>Delete</button></td>
                                            <div id="editModal<?php echo $obj[$i]["schedule_type_id"];?>" class="modal fade" role="dialog">
                                                        ...
                                                        <form role="form" action = "" method = "post">
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label>Tour ID</label>
                                                                    <input class="form-control" name = "schedule_type_id" id = "schedule_type_id" type="text" value = "<?php echo $obj[$i]['schedule_type_id'];?>" disabled="true"/>
                                                                    <p class="help-block">Name or type of service</p>
                                                                </div>
                                                                <input type="hidden" value - <?php echo $obj[$i]['schedule_type_id']?>/>
                                                                <div class="form-group">
                                                                    <label>Room Name</label>
                                                                    <input class="form-control" name = "type_name" id = "<?php echo "type_name".$obj[$i]['schedule_type_id'];?>" type="text" value = "<?php echo $obj[$i]['type_name'] ;?>"></input>

                                                                    <p class="help-block">Name or type of service</p>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>Room Details</label>
                                                                    <textarea class="form-control" name = "type_description" id ="<?php echo "type_description".$obj[$i]['schedule_type_id'];?>"><?php echo  $obj[$i]['type_description']; ?></textarea>
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-default catcat" data-schedule_type_id= "<?php echo $obj[$i]['schedule_type_id']; ?>" value = "Update" name = "submit" id = "edit_cat_submit" >Update</button>
                                                            </div>
                                                        </form>
                                                    </div>
