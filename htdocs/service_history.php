									...
									<table class="table table-hover">
										...
										<?php 
											...
											$sql = "SELECT *,i.fname as workfname, i.lname as worklname,cust.fname as custfname,cust.lname as custlname FROM tbl_service_request r 
													INNER JOIN tbl_service_confirmation c ON r.request_id = c.request_id 
													INNER JOIN tbl_user_info i ON c.worker_id = i.id 
													INNER JOIN tbl_user_info cust ON cust.id = r.customer_id 	
											...
											$nRows = $pdo->query("SELECT COUNT(*) FROM tbl_service_request r 
													...
													INNER JOIN tbl_user_info i ON c.worker_id = i.id 
													INNER JOIN tbl_user_info cust ON cust.id = r.customer_id 
													INNER JOIN tbl_service_detail d ON  r.serv_detail_id = d.serv_detail_id ")->fetchColumn(); 
											for($i = 0 ; $i < $nRows ; $i++){
