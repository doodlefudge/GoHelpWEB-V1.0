                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="inquirer_name" id="inquirer_name"  placeholder="Enter your Name" required="true"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="inquirer_email" id="inquirer_email"  placeholder="Enter your Email" required="true"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="inquirer_phone" id="inquirer_phone"  placeholder="Enter your Phone Number" required="true"/>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name ="adult" id = "adult" required="true">
