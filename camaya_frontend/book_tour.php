...
if(isset($_POST["submit"])){
    ...
    $message  = "<p> Hello, This email was sent because you set a scheduled room reservation/tour package reserved for a date. </p>
             <p> Please Click <a href='http://camayacoast.ph/index.php?schedule_id=$schedule_id'>here</a> to confirm this schedule. </p> ";
                        ...
                        <div class="col-lg-12 col-sm-6 col-xs-12">
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label>From</label>
                                        <input class="datepick" name = "from" id = "from" required="true"/>
                                        <label>To</label>
                                        <input class="datepick" name = "to" id = "to" required="true"/>
                                        <p class="help-block">Reckuring date of the package</p>
                                    </div>

                                    <div class="form-group">
                                        <label>Name of Guests</label>
                                        <textarea class="form-control" name = "guest_list" id ="guest_list" ></textarea>
                ...
                <div class="col-md-12 well text-center">
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                                <input type="text" class="form-control" disabled = "true" name="inquirer_name1" id="inquirer_name1"  placeholder="Enter your Name" required="true"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-envelope fa" aria-hidden="true"></i></span>
                                <input type="text" class="form-control" disabled = "true"  name="inquirer_email1" id="inquirer_email1"  placeholder="Enter your Email" required="true"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-phone fa" aria-hidden="true"></i></span>
                                <input type="text" class="form-control" disabled = "true"  name="inquirer_phone1" id="inquirer_phone1"  placeholder="Enter your Phone Number" required="true"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Select Room Package</label>
                        <select class="form-control" disabled = "true" name ="schedule_type1" id = "schedule_type1" required="true">
                            <?php
                            $sql= "SELECT * from schedule_type where `schedule_type` = 'tour'";
                            $stmt = $pdo->prepare($sql);
                            $stmt->execute();
                    ...
                    <input type = "submit" id="submit" name = "submit" class="btn btn-primary btn-lg" value = "Confirm Schedule" disabled="disabled">
...
<script>
    $(document).ready(function() {
        ...
        $('#activate-step-3').click(function(){
            ...
            $("#from1").val($("#from").val());
            $("#to1").val($("#to").val());
            $("#guest_list1").val($("#guest_list").val());
        });

        $('#guest_list').keyup(function() {
            $('#guest_list1').val( $('#guest_list').val() );
        });
        $('#to').change(function(){
            if($("#from").val() ==""){
