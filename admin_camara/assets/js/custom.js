        ...
        create_request: function (){
			...
			$(".btn.btn-default.req").click(function(){
				if (confirm('Are you sure ?')) {
				  ...
				  var serv_quote = $("#serv_quote"+request_id).val();
				  var worker_id = $("#worker_id"+request_id).val();
				  var serv_summary = $("#serv_summary"+request_id).val();
				  alert(serv_summary);
				  $.ajax({
					type: "POST",
					url: "assets/scripts_php/create_request.php",
					data: "request_id="+request_id+"&serv_quote="+serv_quote+"&serv_summary="+serv_summary+"&worker_id="+worker_id,
				   success: function(html){    
					if(html=='true')    {
