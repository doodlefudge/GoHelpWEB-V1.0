    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">WORKERS</h1>
								...
								<div class="table-responsive">
									<table class="table table-hover">
										...
										<tbody>
											...
											$sql= "SELECT * FROM tbl_user_info i LEFT JOIN tbl_user u ON i.id = u.id WHERE  account_type = '2' "; 
											$stmt = $pdo->prepare($sql);
											$stmt->execute();
											$obj = $stmt->fetchAll();
											$nRows = $pdo->query("SELECT COUNT(*) FROM tbl_user_info i LEFT JOIN tbl_user u ON i.id = u.id WHERE  account_type = '2' ")->fetchColumn();
