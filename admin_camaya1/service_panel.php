    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Scheduled Reservations</h1>
										...
										<?php 
											...
											$nRows = $pdo->query("SELECT COUNT(*) FROM 
                                                                    ...
                                                                    ON 
                                                                      si.inquire_id = ci.inquire_id
                                                                    WHERE 
                                                                      si.schedule_status = 1")->fetchColumn();
											for($i = 0 ; $i < $nRows ; $i++){
													...
													<!-- Modal content-->
														<div class="modal-content">
															...
															<form action = "./service_panel.php" method = 'POST'>
                                                                ...
                                                                <textarea class="form-control" type="text" disabled = 'true' name = "cust_name" id = "cust_name"><?php $sql = "SELECT * FROM 
																...
																<div class="modal-footer">
																	<button type="button" class="btn btn-default req" data-schedule_ID= "<?php echo $obj[$i]["schedule_ID"] ?>" id = "create_request" >Create Confirmation</button>
