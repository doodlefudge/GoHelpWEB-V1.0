                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action = "./service_panel.php" method = 'POST'>
                                                                ...
                                                                <input class="form-control" type="text" disabled = 'true'  id = "schedule_id" name = "<?php echo $obj[$i]['inquire_id'];?>" value = "<?php echo $obj[$i]["inquire_id"] ?>"/>
                                                                ...
                                                                <textarea class="form-control" type="text" disabled = 'true' name = "cust_name" id = "cust_name" ><?php echo $obj[$i]["message_body"]  ?></textarea>
