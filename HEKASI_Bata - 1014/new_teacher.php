                ...
                <div class="well">
                    ...
                    <form action="./new_teacher.php" method="POST">
                        ...
                        <div class="text-right">
                            <a href="./list_teacher.php"class="btn btn-info">Back</a>
        ...
        <script>
            $(function () {
                ...
                var updateUsername = function ()
                {
                    ...
                    $("input[name='username']").val(lastname.replace(' ','').tolower() + '.' + firstname.replace(' ','').tolower());
                };

                $("input[name='first_name']").change(updateUsername);
                $("input[name='last_name']").change(updateUsername);
