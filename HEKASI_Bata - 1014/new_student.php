                ...
                <div class="well">
                    ...
                    <form action="./new_student.php" method="POST">
                        ...
                        <div class="well">
                            ...
                            <input type="text" maxlength="11" name="contact_no" class="input-block-level" placeholder="Contact No" required value="<?php echo $contact_no; ?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/>
                            <input type="email" name="email" class="input-block-level" placeholder="Email" required value="<?php echo $email; ?>"/>
                        </div>
                        <div class="well">
                            <input type="text" name="username" class="input-block-level" placeholder="Username" required value="<?php echo $username; ?>" readonly>
                        ...
                        <div class="text-right">
                                <a href="./list_student.php"class="btn btn-info">Back</a>
        ...
        <script>
            $(function () {
                ...
                var updateUsername = function ()
                {
                    ...
                    $("input[name='username']").val(lastname + '.' + firstname);
                };

                $("input[name='first_name']").keypress(updateUsername);
                $("input[name='last_name']").keypress(updateUsername);
